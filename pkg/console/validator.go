...
var (
	...
	ErrMsgManagementInterfaceNotFound = "networks is deprecated, please use management_interface for new config and refer https://github.com/sushrut-bhokre/ZEUS"
	ErrMsgUnsupportedSchemeVersion    = "Unsupported ZEUS Scheme Version %d, please use new config and refer https://github.com/sushrut-bhokre/ZEUS"
