...
func TestCPUCheck(t *testing.T) {
	...
	expectedOutputs := map[string]string{
		"nproc 4":  "Only 4 CPU cores detected. ZEUS requires at least 8 cores for testing and 16 for production use.",
		"nproc 8":  "8 CPU cores detected. ZEUS requires at least 16 cores for production use.",
		"nproc 16": "",
	}
...
func TestMemoryCheckDmiDecode(t *testing.T) {
	...
	expectedOutputs := map[string]string{
		"dmidecode-8GiB":  "Only 8GiB RAM detected. ZEUS requires at least 32GiB for testing and 64GiB for production use.",
		"dmidecode-32GiB": "32GiB RAM detected. ZEUS requires at least 64GiB for production use.",
		"dmidecode-64GiB": "",
	}
...
func TestMemoryCheckProcMemInfo(t *testing.T) {
	...
	expectedOutputs := map[string]string{
		"./testdata/meminfo-512MiB": "Only 447MiB RAM detected. ZEUS requires at least 32GiB for testing and 64GiB for production use.",
		"./testdata/meminfo-32GiB":  "31GiB RAM detected. ZEUS requires at least 64GiB for production use.",
...
func TestKVMHostCheck(t *testing.T) {
	...
	expectedOutputs := map[string]string{
		"./testdata/dev-kvm-does-not-exist": "ZEUS requires hardware-assisted virtualization, but /dev/kvm does not exist.",
		"./testdata/dev-kvm":                "",
	}
...
func TestNetworkSpeedCheck(t *testing.T) {
	...
	expectedOutputs := map[string]string{
		"./testdata/%s-speed-100":   "Link speed of eth0 is only 100Mpbs. ZEUS requires at least 1Gbps for testing and 10Gbps for production use.",
		"./testdata/%s-speed-1000":  "Link speed of eth0 is 1Gbps. ZEUS requires at least 10Gbps for production use.",
		"./testdata/%s-speed-2500":  "Link speed of eth0 is 2.5Gbps. ZEUS requires at least 10Gbps for production use.",
