...
type LHDefaultSettings struct {
	...
	// the above two are not used afterwards, but ZEUS keeps them for compatibility
...
type HarvesterConfig struct {
	// ZEUS will use scheme version to determine current version and migrate config to new scheme version
